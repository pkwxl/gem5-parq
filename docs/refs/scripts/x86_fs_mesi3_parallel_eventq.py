...
+ N Timing cores, with an optional finer-grained parallel-EventQueue split that
...
Both runs MUST use the same LINK_LATENCY so they simulate the same machine; the
validation is "diff the two m5out/stats.txt" (any difference is a correctness
regression, per design doc 8-9).
...
print(
    ...
    f"cores={NUM_CORES} L2=private/{L2_SIZE} L3=shared/{L3_SIZE} "
